# ddc-slider fork of xfce4-ddc-brighness-slider
...
Fork/rewrite by Musduz, 2025 — switched to ddcutil backend, added per-monitor controls, state cache, contrast support, and tray icon variants.
